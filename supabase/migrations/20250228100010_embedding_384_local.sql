-- Use 384-dimensional embeddings for local model (Xenova/all-MiniLM-L6-v2).
-- Run after phase1. Existing 1536-d embeddings are discarded; re-sync the course to re-embed with the local model.
